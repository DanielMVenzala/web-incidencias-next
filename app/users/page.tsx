 ...
 *
 * Los datos se obtienen del endpoint GET /api/v1/users (solo admins).
 */
'use client';

import { useEffect, useState } from 'react';
import Image from 'next/image';
import { getUsers, toggleBlock, deleteUser, downloadUsersExcel, UserAdmin } from '@/services/users.service';
...
export default function UsersPage() {
  ...
  // Estado del diálogo de confirmación para eliminar
  ...
  async function loadUsers() {
    ...
    try {
      ...
      // Si falla, el interceptor de Axios se encarga del 401
    } finally {
      setLoading(false);
    }
  }
  ...
  // Filtrar usuarios en el frontend según la búsqueda y el rol
